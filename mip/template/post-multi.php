...
{/if}
    <h5><em>作者:{$article.Author.StaticName}</em> <em>分类:{$article.Category.Name}</em> <em>浏览:<mip-zblogphp-article-viewnum post-id="{$article.ID}" default="{$article.ViewNums}" update="0" ></mip-zblogphp-article-viewnum></em> </h5>
  </footer>
</article>
